...
// comme un but) - même forme que le ballon utilisé pour un but réel, mais
// intégralement en vert (au lieu du noir/blanc habituel) pour le distinguer
// d'un coup d'œil.
export function VirtualGoalIcon({ className = 'w-4 h-4 inline-block align-[-3px]' }) {
  return (
    <svg viewBox="0 0 24 24" className={className} aria-hidden="true" fill="none" stroke="#16a34a" strokeWidth="1.3" strokeLinecap="round" strokeLinejoin="round">
