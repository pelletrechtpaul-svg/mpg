...
const AdminAddMatchForm = ({ matchData, saisons, mercatoData, ligueMetadata, showToast, onCancel }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Le nombre de rotaldos (titulaire absent non remplacé) n'est pas
      // stocké : il est dérivé à la volée depuis les notes (voir
      // rotaldosFor dans helpers.js), pour rester correct même si le match
      // est réédité plus tard sans repasser par le triage.
