...
import { groupMatchesByChampionship, calculatePlayerStats } from '../shared.jsx';
...
export const useChampionshipStats = (filteredData, joueurs, ligueMetadata, selectedSeason, selectedLigue, selectedChampionnat) => {
  ...
  }, [filteredData, joueurs, victoiresChampionnat, medaillesChampionnat, victoiresDetail, medaillesDetail]);
